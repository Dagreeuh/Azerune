 ...
 */
export const EFFETS_A_JET=new Set(['temporalShard','agony','alchemyMix','alchemyPoison','corruption','emberBurn','emberSpread','feralBuilder','festeringSpread','festeringStrike','frostBolt','frostNova','frostShatter','gardenPrison','gardenThorn','herbalThorn','highTide','impactFracture','impactQuake','livingGarden','lowTide','refluxDrain','shieldExpose','soulSigil','unstableStun','virulentPoison','virulentSpread']);
export const EFFETS_TEMPORELS=new Set(['refluxRelease','temporalShard','aegisStrike','agony','alchemyMix','alchemyPoison','atonementPenance','atonementShield','breathOfEons','corruption','ebonMight','emberBurn','emberSpread','feralBuilder','festeringSpread','festeringStrike','frostBolt','frostNova','frostShatter','furyRecklessness','gardenPrison','gardenThorn','guardianLink','guardianWall','healingSeed','healingTotem','herbalThorn','highTide','huntMark','impactFracture','impactQuake','livingGarden','lowTide','maelstromTotem','prepareAim','prescienceStrike','refluxDrain','renewingMist','rescueSanctuary','rescueShield','seedBloom','shieldExpose','soulMetamorphosis','soulSigil','tideStanceStrike','temporalHaste','timeWarp','totemHeal','totemTide','unstableStun','vanish','virulentPoison','virulentSpread']);

...
export const EFFETS_TEMPORELS=new Set(['agony','alchemyMix','alchemyPoison','atonementPenance','atonementShield','breathOfEons','corruption','ebonMight','emberBurn','emberSpread','feralBuilder','festeringSpread','festeringStrike','frostBolt','frostNova','frostShatter','furyRecklessness','gardenPrison','gardenThorn','guardianLink','healingSeed','healingTotem','herbalThorn','highTide','huntMark','impactFracture','impactQuake','livingGarden','lowTide','maelstromTotem','prepareAim','prescienceStrike','refluxDrain','renewingMist','seedBloom','shieldExpose','soulSigil','tideStanceStrike','timeAnchor','totemHeal','totemTide','unstableStun','vanish','virulentPoison','virulentSpread']);
